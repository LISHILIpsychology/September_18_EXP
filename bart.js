...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'intro/quit.png', 'path': 'intro/quit.png'},
...
async function experimentInit() {
  ...
  background_8 = new visual.ImageStim({
    ...
    image : 'intro/quit.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, (- 0.48)], 
    draggable: false,
  ...
  text_hint = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_hint',
    text: '按"退出"后，待页面跳转，随后再等待1分钟，看到"Thank you for your patience. Goodbye!" 后(下方图片），再点击"OK"结束实验！\n\n切勿按其他键或强制关闭窗口，否则数据将无法保存！',
    font: 'Arial',
    units: undefined, 
...
function end_fishingRoutineBegin(snapshot) {
  return async function () {
    ...
    end_fishingComponents.push(background_8);
